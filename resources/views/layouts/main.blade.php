...
<div class="flex items-center gap-2 bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 mb-6 text-xs">
  ...
  <button onclick="verificarAPI()" class="px-2.5 py-1 text-xs border border-gray-200 rounded-md bg-white hover:bg-gray-50">
    <i class="ti ti-refresh"></i> Reconectar
  </button>
</div>

<div class="flex border-b border-gray-200 mb-6" role="tablist">
  <button class="tab-btn active" role="tab" onclick="showTab('config')">
    <i class="ti ti-settings"></i> Empresa
  </button>
  <button class="tab-btn" role="tab" onclick="showTab('personas')">
    <i class="ti ti-users"></i> Personas
  </button>
  <button class="tab-btn" role="tab" onclick="showTab('liquidacion')">
    <i class="ti ti-calculator"></i> Liquidación
  </button>
  <button class="tab-btn" role="tab" onclick="showTab('historial')">
